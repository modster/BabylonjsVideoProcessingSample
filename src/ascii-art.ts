...
import { AsciiArtPostProcess } from '@babylonjs/post-processes/asciiArt/asciiArtPostProcess';
...
async function main() {
    ...
    const asciiArtPostProcess = new AsciiArtPostProcess("asciiArt", null, {
        font: "10 Monospace",
        characterSet: " 10100101101001010101000101001000101101110100101",
    });
    ...
    engine.runRenderLoop(() => {
        ...
        // asciiArtPostProcess.mixToNormal = 0.1;
        // asciiArtPostProcess.mixToTile = 0.1;
    });
}
